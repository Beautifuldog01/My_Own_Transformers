...
def get_args():
    ...
    parser.add_argument("--num_layers", type=int, default=6, help="编码器和解码器层数")
    parser.add_argument("--dropout", type=float, default=0.1, help="dropout率")

    # 训练参数
    parser.add_argument("--batch_size", type=int, default=32, help="批次大小")
    parser.add_argument("--num_epochs", type=int, default=10, help="训练轮数")
    parser.add_argument("--learning_rate", type=float, default=1.0, help="学习率")
    parser.add_argument("--warmup_steps", type=int, default=4000, help="预热步数")
    parser.add_argument(
        "--device", type=str, default="cuda", help="训练设备 (cuda/cpu)"
    )
    parser.add_argument(
